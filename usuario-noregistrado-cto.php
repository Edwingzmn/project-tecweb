...
<body>
    ...
    <ul class="nav">
        <li><a href="/project/usuario-noregistrado.html">Principal</a></li>
    ...
    <section name="area-desplegar">
        <form action="/project/add-cto.php" method="POST" class="form-contacto">
            <fieldset>
                ...
                <textarea name="asunto" rows="2" cols="120" required placeholder="Escriba el asunto..."></textarea><br>
                <label for="">Tipo de usuario:</label>
                <select name="tusuario" id="tusuario" required>
                ...
                <textarea name="dasunto" rows="2" cols="120" required placeholder="Escriba una descripción breve del asunto..."></textarea><br>
